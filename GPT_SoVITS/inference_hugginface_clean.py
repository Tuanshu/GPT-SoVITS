# https://huggingface.co/spaces/lj1995/GPT-SoVITS-v2/blob/main/inference_webui.py
'''
按中英混合识别
按日英混合识别
多语种启动切分识别语种
...
change_sovits_weights("GPT_SoVITS/pretrained_models/gsv-v2final-pretrained/s2G2333k.pth")
...
change_gpt_weights("GPT_SoVITS/pretrained_models/gsv-v2final-pretrained/s1bert25hz-5kh-longer-epoch=12-step=369668.ckpt")
